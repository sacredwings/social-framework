...
var CFile = /*#__PURE__*/function () {
  function CFile() {
    _classCallCheck(this, CFile);
  }

  _createClass(CFile, null, [{
    key: "SaveFile",
    value: //Сохраняем новый вайл в таблицу файлов и сам файл
    function () {
      var _SaveFile = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(fields, savePath) {
        var preview,
            collection,
            file_buffer,
            hash,
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                preview = _args.length > 2 && _args[2] !== undefined ? _args[2] : true;
                _context.prev = 1;
                ...
                if (fields.album_ids) fields.album_ids = new _db.DB().arObjectID(fields.album_ids); //id вложенного файла
              ...
              case 11:
                ...
                //хеш содержимого
                hash = _crypto["default"].createHash('md5').update(file_buffer).digest("hex"); //вытаскиваем расширение типа
              ...
              case 19:
                ...
                newPathImg = "".concat(savePath).concat(urlImg);
                _context.prev = 24;
                _context.next = 27;
    ...
    key: "Delete",
    value: function () {
      var _Delete = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(id, deleteFile) {
        var _result2, result;
...
var ImageSave = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(pathVideo, pathImg) {
