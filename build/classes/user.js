        ...
        return regeneratorRuntime.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 11:
                result.personal_photo = _context5.sent;
        ...
        return regeneratorRuntime.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 11:
                result.personal_photo = _context6.sent;
                result.personal_photo = result.personal_photo[0];
          ...
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                ...
                sql = "SELECT * FROM users "; //объединеие параметров запроса
                    ...
                    return regeneratorRuntime.wrap(function _callee10$(_context10) {
                      while (1) {
                        switch (_context10.prev = _context10.next) {
                          ...
                          case 3:
                            item.personal_photo = _context10.sent;
                            item.personal_photo = item.personal_photo[0];
          ...
          while (1) {
            switch (_context12.prev = _context12.next) {
              case 0:
                ...
                sql = "SELECT COUNT(*) FROM users "; //объединеие параметров запроса
