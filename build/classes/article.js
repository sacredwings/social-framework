...
var CArticle = /*#__PURE__*/function () {
  function CArticle() {
    _classCallCheck(this, CArticle);
  }

  _createClass(CArticle, null, [{
    key: "Add",
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.prev = 0;
                if (fields.q) fields.q = fields.q.replace(/ +/g, ' ').trim(); //if (fields.to_group_id)
