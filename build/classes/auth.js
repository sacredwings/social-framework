...
var CAuth = /*#__PURE__*/function () {
  function CAuth() {
    _classCallCheck(this, CAuth);
  }

  _createClass(CAuth, null, [{
    key: "Login",
    value: function () {
      var _Login = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(fields) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return _user.CUser.GetByLogin(fields.login);
    ...
    key: "AddToken",
    value: function () {
      var _AddToken = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(userId, ip, browser) {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                hash = crypto.createHash('md5').update(hash).digest("hex"); //подготовка полей
    ...
    key: "Auth",
    value: function () {
      var _Auth = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(fields) {
        var user;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 3:
                _context4.next = 5;
                return this.GetById([fields.tid]);
              ...
              case 11:
                return _context4.abrupt("return", user.user_id);
