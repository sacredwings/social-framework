...
var CAlbum = /*#__PURE__*/function () {
  function CAlbum() {
    _classCallCheck(this, CAlbum);
  }

  _createClass(CAlbum, null, [{
    key: "Add",
    ...
    key: "Edit",
    value: function () {
      var _Edit = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(id, fields) {
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                if (fields.to_group_id) arAggregate[0].$match.to_group_id = fields.to_group_id; //if (fields.album_id) arAggregate[0].$match.album_id = fields.album_id
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                if (fields.q) arAggregate[0].$match.$text.$search = "\"".concat(fields.q, "\"");
                if (fields.to_user_id) arAggregate[0].$match.to_user_id = fields.to_user_id;
                if (fields.to_group_id) arAggregate[0].$match.to_group_id = fields.to_group_id; //if (fields.album_id) count.album_id = fields.album_id
