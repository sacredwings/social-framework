                      ...
                      while (1) {
                        switch (_context.prev = _context.next) {
                          case 0:
                            ...
                            _context.next = 3;
                            return _db.DB.Init.Insert("albums_link", arFields, "ID");
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                if (fields.album_id) sql = "SELECT video.*\n                    FROM albums_link\n                    INNER JOIN video ON video.id = albums_link.object_id WHERE albums_link.album_id = ".concat(fields.album_id);
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                ...
                if (fields.album_id) sql = "SELECT COUNT(*)\n                    FROM albums_link\n                    WHERE albums_link.album_id = ".concat(fields.album_id);
                _context7.next = 5;
          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                ...
                if (!fields.owner_id) fields.owner_id = fields.from_id;
                _context9.next = 5;
                return _db.DB.Init.Insert("albums", fields, "ID");
        ...
        return regeneratorRuntime.wrap(function _callee11$(_context11) {
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                _context11.prev = 0;
                sql = "SELECT * FROM albums WHERE owner_id=".concat(fields.owner_id, " AND module='video'");
                sql += " LIMIT $1 OFFSET $2 ";
                _context11.next = 5;
                return _db.DB.Init.Query(sql, [fields.count, fields.offset]);
        ...
        return regeneratorRuntime.wrap(function _callee12$(_context12) {
          while (1) {
            switch (_context12.prev = _context12.next) {
              case 0:
                _context12.prev = 0;
                sql = "SELECT COUNT(*) FROM albums WHERE owner_id=".concat(fields.owner_id, " AND module='video'");
                _context12.next = 4;
                return _db.DB.Init.Query(sql);
