...
var CView = /*#__PURE__*/function () {
  ...
  _createClass(CView, null, [{
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                collection = _db.DB.Client.collection('view'); //обработка полей
    ...
    key: "GetByUser",
    value: function () {
      var _GetByUser = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(fields) {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 3:
                fields.object_id = new _db.DB().ObjectID(fields.object_id);
                fields.from_id = new _db.DB().ObjectID(fields.from_id);
                collection = _db.DB.Client.collection('view');
                arFields = {
                  from_id: fields.from_id,
                  object_id: fields.object_id
                };
    ...
    key: "Count",
    value: function () {
      var _Count = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(fields) {
        var collection, arFields, result;
