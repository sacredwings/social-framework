...
export class CImg {
    ...
    static async Edit ( id, fields ) {
        try {
            ...
            console.log(err)
            throw ({code: 8001000, msg: 'CImg Edit'})
        }
    }
    ...
    static async Get ( fields ) {
        try {
            ...
            if (fields.module) arAggregate[0].$match.module = fields.module
            ...
            console.log(err)
            throw ({code: 8001000, msg: 'CImg Get'})
        }
    }
    ...
    static async GetCount ( fields ) {
        try {
            ...
            console.log(err)
            throw ({code: 8001000, msg: 'CImg GetCount'})
        }
    }
    ...
    static async Delete ( id, user_id ) {
        try {
            ...
            console.log(err)
            throw ({code: 7001000, msg: 'CImg Delete'})
        }
    }
}
